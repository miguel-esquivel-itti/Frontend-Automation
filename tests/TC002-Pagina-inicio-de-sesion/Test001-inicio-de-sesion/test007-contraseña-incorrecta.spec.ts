...
test('Ingreso de contraseña incorrecta', async ({ page }) => {
  ...
  await expect(page.locator('text="Su correo electrónico o contraseña son incorrectos, inténtelo de nuevo"')).toBeVisible();
    ...
    const screenshotPath = path.join(carpetaBase, 'Ingreso_de_contraseña_incorrecta.png');
