...
test('Editar rol consulta a admin', async ({ page }) => {
  ...
  await page.getByLabel('AdminAdministradores tienen').check();
  ...
  const screenshotPath = path.join(carpetaBase, 'editar_rol_consulta_a_admin.png');
