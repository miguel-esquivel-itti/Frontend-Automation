...
test('Crear usuario consulta', async ({ page }) => {
  ...
  await page.getByLabel('ConsultaUsuario con acceso').check();
  ...
  const screenshotPath = path.join(carpetaBase, 'Crear_usuario_consulta.png');
